...
#line 55 "fol.y" /* yacc.c:355  */

  #include "header.h"

#line 147 "fol.tab.c" /* yacc.c:355  */
...
{
       0,    86,    86,   106,   121,   122,   125,   128,   129,   132,
     133,   136,   139
};
#endif
...
{
  "$end", "error", "$undefined", "UPPERCASE", "LOWERCASE", "LEFTP",
  "RIGHTP", "NEGATE", "COMMA", "OP", "$accept", "sentence", "exp",
  "literal", "paramlist", "param", "constant", "variable", YY_NULLPTR
};
#endif
...
{
       1,   -11,    -2,     9,   -11,   -11,    11,     1,     6,   -11,
      10,    12,     1,   -11,     2,   -11,   -11,   -11,   -11,    13,
     -11,    10,   -11,   -11
};
...
{
       0,    11,     0,     0,     2,     4,     0,     0,     0,     1,
       0,     0,     0,    12,     0,     8,     9,    10,     5,     0,
       6,     0,     3,     7
};
...
{
      16,     1,     8,     2,     1,     7,     2,    11,    20,     9,
      21,    16,    19,     1,    13,    12,    10,    23,    18,    22
};

static const yytype_uint8 yycheck[] =
{
      10,     3,     2,     5,     3,     7,     5,     7,     6,     0,
       8,    21,    12,     3,     4,     9,     5,    21,     6,     6
};
...
{
       0,     3,     5,    11,    12,    13,    16,     7,    12,     0,
       5,    12,     9,     4,    14,    15,    16,    17,     6,    12,
       6,     8,     6,    15
};
...
#line 1291 "fol.tab.c" /* yacc.c:1661  */
    break;

  case 3:
#line 106 "fol.y" /* yacc.c:1661  */
    {
                                    SentenceFOL *s = new SentenceFOL();
                                    if(string((yyvsp[-2].operat)) == "&") {
                                      s->setOperator(AND);
                                    }
                                    else if(string((yyvsp[-2].operat)) == "|") {
                                      s->setOperator(OR);
                                    }
                                    else if (string((yyvsp[-2].operat)) == "=>") {
                                      s->setOperator(IMPLY);
                                    }
                                    s->setLeftOps((yyvsp[-3].sfol));
                                    s->setRightOps((yyvsp[-1].sfol));
                                    (yyval.sfol) = s;
                                  }
#line 1311 "fol.tab.c" /* yacc.c:1661  */
    break;

  case 4:
#line 121 "fol.y" /* yacc.c:1661  */
    { (yyval.sfol) = new SentenceFOL(*((yyvsp[0].ltr))); }
#line 1317 "fol.tab.c" /* yacc.c:1661  */
    break;

  case 5:
#line 122 "fol.y" /* yacc.c:1661  */
    { (yyvsp[-1].sfol)->negate(); (yyval.sfol) = (yyvsp[-1].sfol); }
#line 1323 "fol.tab.c" /* yacc.c:1661  */
    break;

  case 6:
#line 125 "fol.y" /* yacc.c:1661  */
    { Literal *l = new Literal((yyvsp[-3].element)->stringify()); l->setParams(*((yyvsp[-1].prmlist))); (yyval.ltr) = l; }
#line 1329 "fol.tab.c" /* yacc.c:1661  */
    break;

  case 7:
#line 128 "fol.y" /* yacc.c:1661  */
    { (yyvsp[-2].prmlist)->push_back(*((yyvsp[0].element))); (yyval.prmlist) = (yyvsp[-2].prmlist); }
#line 1335 "fol.tab.c" /* yacc.c:1661  */
    break;

  case 8:
#line 129 "fol.y" /* yacc.c:1661  */
    { vector<Element> *list = new vector<Element>(); list->push_back(*((yyvsp[0].element))); (yyval.prmlist) = list; }
#line 1341 "fol.tab.c" /* yacc.c:1661  */
    break;

  case 9:
#line 132 "fol.y" /* yacc.c:1661  */
    { (yyval.element) = (yyvsp[0].element); }
#line 1347 "fol.tab.c" /* yacc.c:1661  */
    break;

  case 10:
#line 133 "fol.y" /* yacc.c:1661  */
    { (yyval.element) = (yyvsp[0].element); }
#line 1353 "fol.tab.c" /* yacc.c:1661  */
    break;

  case 11:
#line 136 "fol.y" /* yacc.c:1661  */
    { (yyval.element) = new Element(string((yyvsp[0].uppercase))); }
#line 1359 "fol.tab.c" /* yacc.c:1661  */
    break;

  case 12:
#line 139 "fol.y" /* yacc.c:1661  */
    {
      string name = string((yyvsp[0].lowercase));
      UNIV_ID_TYPE id;
      ...
      (yyval.element) = new Element(inside_literal_universal_name_to_id_map[name]);
    }
#line 1372 "fol.tab.c" /* yacc.c:1661  */
    break;


#line 1376 "fol.tab.c" /* yacc.c:1661  */
      default: break;
    }
    ...
    for(int q = 0; q < query_size; q++) {
          ...
          while(!conflict_found) {
            ...
            if(conflict_found) {
              ...
              cout<<"ORIGIN QUERY IS : TRUE" <<endl;
              ...
              cout<<"ORIGIN QUERY IS : FALSE" <<endl;
